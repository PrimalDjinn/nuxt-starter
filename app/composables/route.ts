...
// export default function <T extends z.core.$ZodShape, S extends z.core.$ZodObject<T>, O = Partial<z.infer<S>>, D = DeepPartial<O>>(schema: S, initial?: D) {
//   const blank = {} as Partial<O>
//   if (initial) {
//     Object.assign(blank, initial)
//   }
